...
export type AssetKeySpecifier = ('alt' | 'assetPage' | 'assetPageLink' | 'assetRowHeroBanner' | 'assetRowProduct' | 'createdAt' | 'createdBy' | 'documentInStages' | 'fileName' | 'handle' | 'height' | 'history' | 'id' | 'imageBanner' | 'locale' | 'localizations' | 'mimeType' | 'publishedAt' | 'publishedBy' | 'rowSpecialBannerAsset' | 'scheduledIn' | 'size' | 'stage' | 'updatedAt' | 'updatedBy' | 'url' | 'width' | AssetKeySpecifier)[];
export type AssetFieldPolicy = {
	...
	imageBanner?: FieldPolicy<any> | FieldReadFunction<any>,
...
export type BannerKeySpecifier = ('copy' | 'createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'image' | 'locale' | 'localizations' | 'pages' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'updatedAt' | 'updatedBy' | BannerKeySpecifier)[];
...
export type BannerConnectionKeySpecifier = ('aggregate' | 'edges' | 'pageInfo' | BannerConnectionKeySpecifier)[];
export type BannerConnectionFieldPolicy = {
	aggregate?: FieldPolicy<any> | FieldReadFunction<any>,
	edges?: FieldPolicy<any> | FieldReadFunction<any>,
	pageInfo?: FieldPolicy<any> | FieldReadFunction<any>
};
export type BannerEdgeKeySpecifier = ('cursor' | 'node' | BannerEdgeKeySpecifier)[];
export type BannerEdgeFieldPolicy = {
	cursor?: FieldPolicy<any> | FieldReadFunction<any>,
	node?: FieldPolicy<any> | FieldReadFunction<any>
};
...
export type FooterKeySpecifier = ('copyright' | 'createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'legalLinks' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'socialLinks' | 'stage' | 'updatedAt' | 'updatedBy' | FooterKeySpecifier)[];
...
export type MutationKeySpecifier = ('addBundleProductsToCart' | 'addConfigurableProductsToCart' | 'addDownloadableProductsToCart' | 'addProductsToCart' | 'addProductsToCompareList' | 'addProductsToWishlist' | 'addSimpleProductsToCart' | 'addVirtualProductsToCart' | 'addWishlistItemsToCart' | 'applyCouponToCart' | 'assignCompareListToCustomer' | 'changeCustomerPassword' | 'createAsset' | 'createBanner' | 'createBraintreeClientToken' | 'createCompareList' | 'createCustomer' | 'createCustomerAddress' | 'createCustomerV2' | 'createEmptyCart' | 'createFooter' | 'createKlarnaPaymentsSession' | 'createMollieTransaction' | 'createPage' | 'createPageLink' | 'createPayflowProToken' | 'createPaypalExpressToken' | 'createProductReview' | 'createRowBlogContent' | 'createRowButtonLinkList' | 'createRowColumnOne' | 'createRowColumnThree' | 'createRowColumnTwo' | 'createRowContentLinks' | 'createRowHeroBanner' | 'createRowLinks' | 'createRowProduct' | 'createRowQuote' | 'createRowServiceOptions' | 'createRowSpecialBanner' | 'createScheduledRelease' | 'createUsps' | 'deleteAsset' | 'deleteBanner' | 'deleteCompareList' | 'deleteCustomerAddress' | 'deleteFooter' | 'deleteManyAssets' | 'deleteManyAssetsConnection' | 'deleteManyBanners' | 'deleteManyBannersConnection' | 'deleteManyFooters' | 'deleteManyFootersConnection' | 'deleteManyPageLinks' | 'deleteManyPageLinksConnection' | 'deleteManyPages' | 'deleteManyPagesConnection' | 'deleteManyRowBlogContents' | 'deleteManyRowBlogContentsConnection' | 'deleteManyRowButtonLinkLists' | 'deleteManyRowButtonLinkListsConnection' | 'deleteManyRowColumnOnes' | 'deleteManyRowColumnOnesConnection' | 'deleteManyRowColumnThrees' | 'deleteManyRowColumnThreesConnection' | 'deleteManyRowColumnTwos' | 'deleteManyRowColumnTwosConnection' | 'deleteManyRowContentLinksMultiple' | 'deleteManyRowContentLinksMultipleConnection' | 'deleteManyRowHeroBanners' | 'deleteManyRowHeroBannersConnection' | 'deleteManyRowLinksMultiple' | 'deleteManyRowLinksMultipleConnection' | 'deleteManyRowProductMultiple' | 'deleteManyRowProductMultipleConnection' | 'deleteManyRowQuotes' | 'deleteManyRowQuotesConnection' | 'deleteManyRowServiceOptionsMultiple' | 'deleteManyRowServiceOptionsMultipleConnection' | 'deleteManyRowSpecialBanners' | 'deleteManyRowSpecialBannersConnection' | 'deleteManyUspsMultiple' | 'deleteManyUspsMultipleConnection' | 'deletePage' | 'deletePageLink' | 'deletePaymentToken' | 'deleteRowBlogContent' | 'deleteRowButtonLinkList' | 'deleteRowColumnOne' | 'deleteRowColumnThree' | 'deleteRowColumnTwo' | 'deleteRowContentLinks' | 'deleteRowHeroBanner' | 'deleteRowLinks' | 'deleteRowProduct' | 'deleteRowQuote' | 'deleteRowServiceOptions' | 'deleteRowSpecialBanner' | 'deleteScheduledOperation' | 'deleteScheduledRelease' | 'deleteUsps' | 'generateCustomerToken' | 'generateCustomerTokenAsAdmin' | 'handlePayflowProResponse' | 'mergeCarts' | 'mollieProcessTransaction' | 'mollieRestoreCart' | 'placeOrder' | 'publishAsset' | 'publishBanner' | 'publishFooter' | 'publishManyAssets' | 'publishManyAssetsConnection' | 'publishManyBanners' | 'publishManyBannersConnection' | 'publishManyFooters' | 'publishManyFootersConnection' | 'publishManyPageLinks' | 'publishManyPageLinksConnection' | 'publishManyPages' | 'publishManyPagesConnection' | 'publishManyRowBlogContents' | 'publishManyRowBlogContentsConnection' | 'publishManyRowButtonLinkLists' | 'publishManyRowButtonLinkListsConnection' | 'publishManyRowColumnOnes' | 'publishManyRowColumnOnesConnection' | 'publishManyRowColumnThrees' | 'publishManyRowColumnThreesConnection' | 'publishManyRowColumnTwos' | 'publishManyRowColumnTwosConnection' | 'publishManyRowContentLinksMultiple' | 'publishManyRowContentLinksMultipleConnection' | 'publishManyRowHeroBanners' | 'publishManyRowHeroBannersConnection' | 'publishManyRowLinksMultiple' | 'publishManyRowLinksMultipleConnection' | 'publishManyRowProductMultiple' | 'publishManyRowProductMultipleConnection' | 'publishManyRowQuotes' | 'publishManyRowQuotesConnection' | 'publishManyRowServiceOptionsMultiple' | 'publishManyRowServiceOptionsMultipleConnection' | 'publishManyRowSpecialBanners' | 'publishManyRowSpecialBannersConnection' | 'publishManyUspsMultiple' | 'publishManyUspsMultipleConnection' | 'publishPage' | 'publishPageLink' | 'publishRowBlogContent' | 'publishRowButtonLinkList' | 'publishRowColumnOne' | 'publishRowColumnThree' | 'publishRowColumnTwo' | 'publishRowContentLinks' | 'publishRowHeroBanner' | 'publishRowLinks' | 'publishRowProduct' | 'publishRowQuote' | 'publishRowServiceOptions' | 'publishRowSpecialBanner' | 'publishUsps' | 'removeCouponFromCart' | 'removeItemFromCart' | 'removeProductsFromCompareList' | 'removeProductsFromWishlist' | 'reorderItems' | 'requestPasswordResetEmail' | 'resetPassword' | 'revokeCustomerToken' | 'schedulePublishAsset' | 'schedulePublishBanner' | 'schedulePublishFooter' | 'schedulePublishPage' | 'schedulePublishPageLink' | 'schedulePublishRowBlogContent' | 'schedulePublishRowButtonLinkList' | 'schedulePublishRowColumnOne' | 'schedulePublishRowColumnThree' | 'schedulePublishRowColumnTwo' | 'schedulePublishRowContentLinks' | 'schedulePublishRowHeroBanner' | 'schedulePublishRowLinks' | 'schedulePublishRowProduct' | 'schedulePublishRowQuote' | 'schedulePublishRowServiceOptions' | 'schedulePublishRowSpecialBanner' | 'schedulePublishUsps' | 'scheduleUnpublishAsset' | 'scheduleUnpublishBanner' | 'scheduleUnpublishFooter' | 'scheduleUnpublishPage' | 'scheduleUnpublishPageLink' | 'scheduleUnpublishRowBlogContent' | 'scheduleUnpublishRowButtonLinkList' | 'scheduleUnpublishRowColumnOne' | 'scheduleUnpublishRowColumnThree' | 'scheduleUnpublishRowColumnTwo' | 'scheduleUnpublishRowContentLinks' | 'scheduleUnpublishRowHeroBanner' | 'scheduleUnpublishRowLinks' | 'scheduleUnpublishRowProduct' | 'scheduleUnpublishRowQuote' | 'scheduleUnpublishRowServiceOptions' | 'scheduleUnpublishRowSpecialBanner' | 'scheduleUnpublishUsps' | 'sendEmailToFriend' | 'setBillingAddressOnCart' | 'setGuestEmailOnCart' | 'setPaymentMethodAndPlaceOrder' | 'setPaymentMethodOnCart' | 'setShippingAddressesOnCart' | 'setShippingMethodsOnCart' | 'subscribeEmailToNewsletter' | 'unpublishAsset' | 'unpublishBanner' | 'unpublishFooter' | 'unpublishManyAssets' | 'unpublishManyAssetsConnection' | 'unpublishManyBanners' | 'unpublishManyBannersConnection' | 'unpublishManyFooters' | 'unpublishManyFootersConnection' | 'unpublishManyPageLinks' | 'unpublishManyPageLinksConnection' | 'unpublishManyPages' | 'unpublishManyPagesConnection' | 'unpublishManyRowBlogContents' | 'unpublishManyRowBlogContentsConnection' | 'unpublishManyRowButtonLinkLists' | 'unpublishManyRowButtonLinkListsConnection' | 'unpublishManyRowColumnOnes' | 'unpublishManyRowColumnOnesConnection' | 'unpublishManyRowColumnThrees' | 'unpublishManyRowColumnThreesConnection' | 'unpublishManyRowColumnTwos' | 'unpublishManyRowColumnTwosConnection' | 'unpublishManyRowContentLinksMultiple' | 'unpublishManyRowContentLinksMultipleConnection' | 'unpublishManyRowHeroBanners' | 'unpublishManyRowHeroBannersConnection' | 'unpublishManyRowLinksMultiple' | 'unpublishManyRowLinksMultipleConnection' | 'unpublishManyRowProductMultiple' | 'unpublishManyRowProductMultipleConnection' | 'unpublishManyRowQuotes' | 'unpublishManyRowQuotesConnection' | 'unpublishManyRowServiceOptionsMultiple' | 'unpublishManyRowServiceOptionsMultipleConnection' | 'unpublishManyRowSpecialBanners' | 'unpublishManyRowSpecialBannersConnection' | 'unpublishManyUspsMultiple' | 'unpublishManyUspsMultipleConnection' | 'unpublishPage' | 'unpublishPageLink' | 'unpublishRowBlogContent' | 'unpublishRowButtonLinkList' | 'unpublishRowColumnOne' | 'unpublishRowColumnThree' | 'unpublishRowColumnTwo' | 'unpublishRowContentLinks' | 'unpublishRowHeroBanner' | 'unpublishRowLinks' | 'unpublishRowProduct' | 'unpublishRowQuote' | 'unpublishRowServiceOptions' | 'unpublishRowSpecialBanner' | 'unpublishUsps' | 'updateAsset' | 'updateBanner' | 'updateCartItems' | 'updateChatProfile' | 'updateCustomer' | 'updateCustomerAddress' | 'updateCustomerEmail' | 'updateCustomerV2' | 'updateFooter' | 'updateManyAssets' | 'updateManyAssetsConnection' | 'updateManyBanners' | 'updateManyBannersConnection' | 'updateManyFooters' | 'updateManyFootersConnection' | 'updateManyPageLinks' | 'updateManyPageLinksConnection' | 'updateManyPages' | 'updateManyPagesConnection' | 'updateManyRowBlogContents' | 'updateManyRowBlogContentsConnection' | 'updateManyRowButtonLinkLists' | 'updateManyRowButtonLinkListsConnection' | 'updateManyRowColumnOnes' | 'updateManyRowColumnOnesConnection' | 'updateManyRowColumnThrees' | 'updateManyRowColumnThreesConnection' | 'updateManyRowColumnTwos' | 'updateManyRowColumnTwosConnection' | 'updateManyRowContentLinksMultiple' | 'updateManyRowContentLinksMultipleConnection' | 'updateManyRowHeroBanners' | 'updateManyRowHeroBannersConnection' | 'updateManyRowLinksMultiple' | 'updateManyRowLinksMultipleConnection' | 'updateManyRowProductMultiple' | 'updateManyRowProductMultipleConnection' | 'updateManyRowQuotes' | 'updateManyRowQuotesConnection' | 'updateManyRowServiceOptionsMultiple' | 'updateManyRowServiceOptionsMultipleConnection' | 'updateManyRowSpecialBanners' | 'updateManyRowSpecialBannersConnection' | 'updateManyUspsMultiple' | 'updateManyUspsMultipleConnection' | 'updatePage' | 'updatePageLink' | 'updateProductsInWishlist' | 'updateQuoteEmail' | 'updateRowBlogContent' | 'updateRowButtonLinkList' | 'updateRowColumnOne' | 'updateRowColumnThree' | 'updateRowColumnTwo' | 'updateRowContentLinks' | 'updateRowHeroBanner' | 'updateRowLinks' | 'updateRowProduct' | 'updateRowQuote' | 'updateRowServiceOptions' | 'updateRowSpecialBanner' | 'updateScheduledRelease' | 'updateUsps' | 'upsertAsset' | 'upsertBanner' | 'upsertFooter' | 'upsertPage' | 'upsertPageLink' | 'upsertRowBlogContent' | 'upsertRowButtonLinkList' | 'upsertRowColumnOne' | 'upsertRowColumnThree' | 'upsertRowColumnTwo' | 'upsertRowContentLinks' | 'upsertRowHeroBanner' | 'upsertRowLinks' | 'upsertRowProduct' | 'upsertRowQuote' | 'upsertRowServiceOptions' | 'upsertRowSpecialBanner' | 'upsertUsps' | MutationKeySpecifier)[];
export type MutationFieldPolicy = {
	...
	createBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	createFooter?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	createPageLink?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	createRowBlogContent?: FieldPolicy<any> | FieldReadFunction<any>,
	createRowButtonLinkList?: FieldPolicy<any> | FieldReadFunction<any>,
	createRowColumnOne?: FieldPolicy<any> | FieldReadFunction<any>,
	createRowColumnThree?: FieldPolicy<any> | FieldReadFunction<any>,
	createRowColumnTwo?: FieldPolicy<any> | FieldReadFunction<any>,
	createRowContentLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	createRowHeroBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	createRowLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	createRowProduct?: FieldPolicy<any> | FieldReadFunction<any>,
	createRowQuote?: FieldPolicy<any> | FieldReadFunction<any>,
	createRowServiceOptions?: FieldPolicy<any> | FieldReadFunction<any>,
	createRowSpecialBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	createScheduledRelease?: FieldPolicy<any> | FieldReadFunction<any>,
	createUsps?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteAsset?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteCompareList?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteCustomerAddress?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteFooter?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyAssets?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyAssetsConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyBannersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyFooters?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyFootersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyPageLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyPageLinksConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyPages?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyPagesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowBlogContents?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowBlogContentsConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowButtonLinkLists?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowButtonLinkListsConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowColumnOnes?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowColumnOnesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowColumnThrees?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowColumnThreesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowColumnTwos?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowColumnTwosConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowContentLinksMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowContentLinksMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowHeroBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowHeroBannersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowLinksMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowLinksMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowProductMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowProductMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowQuotes?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowQuotesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowServiceOptionsMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowServiceOptionsMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowSpecialBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyRowSpecialBannersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyUspsMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteManyUspsMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	deletePage?: FieldPolicy<any> | FieldReadFunction<any>,
	deletePageLink?: FieldPolicy<any> | FieldReadFunction<any>,
	deletePaymentToken?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteRowBlogContent?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteRowButtonLinkList?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteRowColumnOne?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteRowColumnThree?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteRowColumnTwo?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteRowContentLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteRowHeroBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteRowLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteRowProduct?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteRowQuote?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteRowServiceOptions?: FieldPolicy<any> | FieldReadFunction<any>,
	deleteRowSpecialBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	deleteUsps?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	publishBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	publishFooter?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyAssets?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyAssetsConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyBannersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyFooters?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyFootersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyPageLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyPageLinksConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyPages?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyPagesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowBlogContents?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowBlogContentsConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowButtonLinkLists?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowButtonLinkListsConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowColumnOnes?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowColumnOnesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowColumnThrees?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowColumnThreesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowColumnTwos?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowColumnTwosConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowContentLinksMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowContentLinksMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowHeroBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowHeroBannersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowLinksMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowLinksMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowProductMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowProductMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowQuotes?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowQuotesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowServiceOptionsMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowServiceOptionsMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowSpecialBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyRowSpecialBannersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyUspsMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	publishManyUspsMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	publishPage?: FieldPolicy<any> | FieldReadFunction<any>,
	publishPageLink?: FieldPolicy<any> | FieldReadFunction<any>,
	publishRowBlogContent?: FieldPolicy<any> | FieldReadFunction<any>,
	publishRowButtonLinkList?: FieldPolicy<any> | FieldReadFunction<any>,
	publishRowColumnOne?: FieldPolicy<any> | FieldReadFunction<any>,
	publishRowColumnThree?: FieldPolicy<any> | FieldReadFunction<any>,
	publishRowColumnTwo?: FieldPolicy<any> | FieldReadFunction<any>,
	publishRowContentLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	publishRowHeroBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	publishRowLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	publishRowProduct?: FieldPolicy<any> | FieldReadFunction<any>,
	publishRowQuote?: FieldPolicy<any> | FieldReadFunction<any>,
	publishRowServiceOptions?: FieldPolicy<any> | FieldReadFunction<any>,
	publishRowSpecialBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	publishUsps?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	schedulePublishBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishFooter?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishPage?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishPageLink?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishRowBlogContent?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishRowButtonLinkList?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishRowColumnOne?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishRowColumnThree?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishRowColumnTwo?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishRowContentLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishRowHeroBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishRowLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishRowProduct?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishRowQuote?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishRowServiceOptions?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishRowSpecialBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	schedulePublishUsps?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishAsset?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishFooter?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishPage?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishPageLink?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishRowBlogContent?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishRowButtonLinkList?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishRowColumnOne?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishRowColumnThree?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishRowColumnTwo?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishRowContentLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishRowHeroBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishRowLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishRowProduct?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishRowQuote?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishRowServiceOptions?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishRowSpecialBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	scheduleUnpublishUsps?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	unpublishBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishFooter?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	unpublishManyBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyBannersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyFooters?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyFootersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyPageLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyPageLinksConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyPages?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyPagesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowBlogContents?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowBlogContentsConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowButtonLinkLists?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowButtonLinkListsConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowColumnOnes?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowColumnOnesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowColumnThrees?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowColumnThreesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowColumnTwos?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowColumnTwosConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowContentLinksMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowContentLinksMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowHeroBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowHeroBannersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowLinksMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowLinksMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowProductMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowProductMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowQuotes?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowQuotesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowServiceOptionsMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowServiceOptionsMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowSpecialBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyRowSpecialBannersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyUspsMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishManyUspsMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishPage?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishPageLink?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishRowBlogContent?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishRowButtonLinkList?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishRowColumnOne?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishRowColumnThree?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishRowColumnTwo?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishRowContentLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishRowHeroBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishRowLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishRowProduct?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishRowQuote?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishRowServiceOptions?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishRowSpecialBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	unpublishUsps?: FieldPolicy<any> | FieldReadFunction<any>,
	updateAsset?: FieldPolicy<any> | FieldReadFunction<any>,
	updateBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	updateFooter?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyAssets?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyAssetsConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyBannersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyFooters?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyFootersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyPageLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyPageLinksConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyPages?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyPagesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowBlogContents?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowBlogContentsConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowButtonLinkLists?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowButtonLinkListsConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowColumnOnes?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowColumnOnesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowColumnThrees?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowColumnThreesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowColumnTwos?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowColumnTwosConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowContentLinksMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowContentLinksMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowHeroBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowHeroBannersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowLinksMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowLinksMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowProductMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowProductMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowQuotes?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowQuotesConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowServiceOptionsMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowServiceOptionsMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowSpecialBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyRowSpecialBannersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyUspsMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	updateManyUspsMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	updatePage?: FieldPolicy<any> | FieldReadFunction<any>,
	updatePageLink?: FieldPolicy<any> | FieldReadFunction<any>,
	updateProductsInWishlist?: FieldPolicy<any> | FieldReadFunction<any>,
	updateQuoteEmail?: FieldPolicy<any> | FieldReadFunction<any>,
	updateRowBlogContent?: FieldPolicy<any> | FieldReadFunction<any>,
	updateRowButtonLinkList?: FieldPolicy<any> | FieldReadFunction<any>,
	updateRowColumnOne?: FieldPolicy<any> | FieldReadFunction<any>,
	updateRowColumnThree?: FieldPolicy<any> | FieldReadFunction<any>,
	updateRowColumnTwo?: FieldPolicy<any> | FieldReadFunction<any>,
	updateRowContentLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	updateRowHeroBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	updateRowLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	updateRowProduct?: FieldPolicy<any> | FieldReadFunction<any>,
	updateRowQuote?: FieldPolicy<any> | FieldReadFunction<any>,
	updateRowServiceOptions?: FieldPolicy<any> | FieldReadFunction<any>,
	updateRowSpecialBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	updateScheduledRelease?: FieldPolicy<any> | FieldReadFunction<any>,
	updateUsps?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertAsset?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertFooter?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertPage?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertPageLink?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertRowBlogContent?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertRowButtonLinkList?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertRowColumnOne?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertRowColumnThree?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertRowColumnTwo?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertRowContentLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertRowHeroBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertRowLinks?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertRowProduct?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertRowQuote?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertRowServiceOptions?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertRowSpecialBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	upsertUsps?: FieldPolicy<any> | FieldReadFunction<any>
};
...
export type PageKeySpecifier = ('asset' | 'author' | 'childPages' | 'content' | 'createdAt' | 'createdBy' | 'date' | 'documentInStages' | 'history' | 'id' | 'locale' | 'localizations' | 'metaDescription' | 'metaRobots' | 'metaTitle' | 'publishedAt' | 'publishedBy' | 'relatedPages' | 'rowButtonLinkLists' | 'scheduledIn' | 'stage' | 'title' | 'updatedAt' | 'updatedBy' | 'url' | PageKeySpecifier)[];
...
export type PageLinkKeySpecifier = ('asset' | 'createdAt' | 'createdBy' | 'description' | 'documentInStages' | 'footerLegalLinks' | 'footerSocialLinks' | 'history' | 'id' | 'locale' | 'localizations' | 'publishedAt' | 'publishedBy' | 'rowContentLinks' | 'rowHeroBanners' | 'rowLinks' | 'rowProductMultiple' | 'rowServiceOptionsMultiple' | 'rowSpecialBanners' | 'scheduledIn' | 'stage' | 'title' | 'updatedAt' | 'updatedBy' | 'url' | 'uspsMultiple' | PageLinkKeySpecifier)[];
...
export type QueryKeySpecifier = ('asset' | 'assetVersion' | 'assets' | 'assetsConnection' | 'availableStores' | 'banner' | 'bannerVersion' | 'banners' | 'bannersConnection' | 'cart' | 'categories' | 'category' | 'categoryList' | 'chatData' | 'checkoutAgreements' | 'cmsBlocks' | 'cmsPage' | 'compareList' | 'countries' | 'country' | 'currency' | 'currentCartId' | 'customAttributeMetadata' | 'customer' | 'customerCart' | 'customerDownloadableProducts' | 'customerOrders' | 'customerPaymentTokens' | 'customerToken' | 'emailCaptureCheckout' | 'emailCaptureNewsletter' | 'footer' | 'footerVersion' | 'footers' | 'footersConnection' | 'getHostedProUrl' | 'getPayflowLinkToken' | 'guestWishlist' | 'isEmailAvailable' | 'mollieCustomerOrder' | 'molliePaymentMethods' | 'node' | 'orderData' | 'page' | 'pageLink' | 'pageLinkVersion' | 'pageLinks' | 'pageLinksConnection' | 'pageVersion' | 'pages' | 'pagesConnection' | 'pickupLocations' | 'productReviewRatingsMetadata' | 'products' | 'route' | 'rowBlogContent' | 'rowBlogContentVersion' | 'rowBlogContents' | 'rowBlogContentsConnection' | 'rowButtonLinkList' | 'rowButtonLinkListVersion' | 'rowButtonLinkLists' | 'rowButtonLinkListsConnection' | 'rowColumnOne' | 'rowColumnOneVersion' | 'rowColumnOnes' | 'rowColumnOnesConnection' | 'rowColumnThree' | 'rowColumnThreeVersion' | 'rowColumnThrees' | 'rowColumnThreesConnection' | 'rowColumnTwo' | 'rowColumnTwoVersion' | 'rowColumnTwos' | 'rowColumnTwosConnection' | 'rowContentLinks' | 'rowContentLinksMultiple' | 'rowContentLinksMultipleConnection' | 'rowContentLinksVersion' | 'rowHeroBanner' | 'rowHeroBannerVersion' | 'rowHeroBanners' | 'rowHeroBannersConnection' | 'rowLinks' | 'rowLinksMultiple' | 'rowLinksMultipleConnection' | 'rowLinksVersion' | 'rowProduct' | 'rowProductMultiple' | 'rowProductMultipleConnection' | 'rowProductVersion' | 'rowQuote' | 'rowQuoteVersion' | 'rowQuotes' | 'rowQuotesConnection' | 'rowServiceOptions' | 'rowServiceOptionsMultiple' | 'rowServiceOptionsMultipleConnection' | 'rowServiceOptionsVersion' | 'rowSpecialBanner' | 'rowSpecialBannerVersion' | 'rowSpecialBanners' | 'rowSpecialBannersConnection' | 'scheduledOperation' | 'scheduledOperations' | 'scheduledOperationsConnection' | 'scheduledRelease' | 'scheduledReleases' | 'scheduledReleasesConnection' | 'storeConfig' | 'trackingData' | 'urlResolver' | 'user' | 'users' | 'usersConnection' | 'usps' | 'uspsMultiple' | 'uspsMultipleConnection' | 'uspsVersion' | 'wishlist' | QueryKeySpecifier)[];
export type QueryFieldPolicy = {
	...
	bannerVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	banners?: FieldPolicy<any> | FieldReadFunction<any>,
	bannersConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	cart?: FieldPolicy<any> | FieldReadFunction<any>,
	categories?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	footerVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	rowBlogContentVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	rowButtonLinkListVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	rowButtonLinkLists?: FieldPolicy<any> | FieldReadFunction<any>,
	rowButtonLinkListsConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	rowColumnOne?: FieldPolicy<any> | FieldReadFunction<any>,
	rowColumnOneVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	rowColumnThreeVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	rowColumnTwoVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	rowContentLinksVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	rowHeroBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	rowHeroBannerVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	rowHeroBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	rowLinksVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	rowProduct?: FieldPolicy<any> | FieldReadFunction<any>,
	rowProductMultiple?: FieldPolicy<any> | FieldReadFunction<any>,
	rowProductMultipleConnection?: FieldPolicy<any> | FieldReadFunction<any>,
	rowProductVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	rowQuote?: FieldPolicy<any> | FieldReadFunction<any>,
	rowQuoteVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	rowServiceOptionsVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	rowSpecialBanner?: FieldPolicy<any> | FieldReadFunction<any>,
	rowSpecialBannerVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	rowSpecialBanners?: FieldPolicy<any> | FieldReadFunction<any>,
	...
	uspsVersion?: FieldPolicy<any> | FieldReadFunction<any>,
	wishlist?: FieldPolicy<any> | FieldReadFunction<any>
};
...
export type RowBlogContentKeySpecifier = ('content' | 'createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'locale' | 'localizations' | 'pages' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'updatedAt' | 'updatedBy' | RowBlogContentKeySpecifier)[];
...
export type RowButtonLinkListKeySpecifier = ('createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'links' | 'locale' | 'localizations' | 'pages' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'title' | 'updatedAt' | 'updatedBy' | RowButtonLinkListKeySpecifier)[];
...
export type RowColumnOneKeySpecifier = ('colOne' | 'createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'locale' | 'localizations' | 'pages' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'updatedAt' | 'updatedBy' | RowColumnOneKeySpecifier)[];
...
export type RowColumnThreeKeySpecifier = ('colOne' | 'colThree' | 'colTwo' | 'createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'locale' | 'localizations' | 'pages' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'updatedAt' | 'updatedBy' | RowColumnThreeKeySpecifier)[];
...
export type RowColumnTwoKeySpecifier = ('colOne' | 'colTwo' | 'createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'locale' | 'localizations' | 'pages' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'updatedAt' | 'updatedBy' | RowColumnTwoKeySpecifier)[];
...
export type RowContentLinksKeySpecifier = ('contentLinks' | 'createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'locale' | 'localizations' | 'pages' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'title' | 'updatedAt' | 'updatedBy' | RowContentLinksKeySpecifier)[];
...
export type RowHeroBannerKeySpecifier = ('asset' | 'copy' | 'createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'locale' | 'localizations' | 'pageLinks' | 'pages' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'updatedAt' | 'updatedBy' | RowHeroBannerKeySpecifier)[];
...
export type RowLinksKeySpecifier = ('createdAt' | 'createdBy' | 'description' | 'documentInStages' | 'history' | 'id' | 'identity' | 'linksVariant' | 'locale' | 'localizations' | 'pageLinks' | 'pages' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'title' | 'updatedAt' | 'updatedBy' | RowLinksKeySpecifier)[];
...
export type RowProductKeySpecifier = ('asset' | 'createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'locale' | 'localizations' | 'pageLinks' | 'pages' | 'productCopy' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'title' | 'updatedAt' | 'updatedBy' | 'variant' | RowProductKeySpecifier)[];
...
export type RowQuoteKeySpecifier = ('createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'locale' | 'localizations' | 'pages' | 'publishedAt' | 'publishedBy' | 'quote' | 'scheduledIn' | 'stage' | 'updatedAt' | 'updatedBy' | RowQuoteKeySpecifier)[];
...
export type RowServiceOptionsKeySpecifier = ('createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'locale' | 'localizations' | 'pages' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'serviceOptions' | 'stage' | 'title' | 'updatedAt' | 'updatedBy' | RowServiceOptionsKeySpecifier)[];
...
export type RowSpecialBannerKeySpecifier = ('asset' | 'copy' | 'createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'locale' | 'localizations' | 'pageLinks' | 'pages' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'topic' | 'updatedAt' | 'updatedBy' | RowSpecialBannerKeySpecifier)[];
...
export type UspsKeySpecifier = ('createdAt' | 'createdBy' | 'documentInStages' | 'history' | 'id' | 'identity' | 'publishedAt' | 'publishedBy' | 'scheduledIn' | 'stage' | 'updatedAt' | 'updatedBy' | 'uspsMultiple' | UspsKeySpecifier)[];
...
export type StrictTypedTypePolicies = {
	...
	BannerConnection?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | BannerConnectionKeySpecifier | (() => undefined | BannerConnectionKeySpecifier),
		fields?: BannerConnectionFieldPolicy,
	},
	BannerEdge?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | BannerEdgeKeySpecifier | (() => undefined | BannerEdgeKeySpecifier),
		fields?: BannerEdgeFieldPolicy,
	},
