...
export type ProductListItemProps = BaseProps & Product & {
  sx?: SxProps<Theme>
        ...
        <>
          ...
          >
            ...
            <ProductListPrice
              ...
              regular_price={{value: price.retailPrice}}
              sx={{
                gridArea: 'price',
                textAlign: 'right',
...
IserProductListItem.selectors = { ...selectors, ...ProductListPrice.selectors }
