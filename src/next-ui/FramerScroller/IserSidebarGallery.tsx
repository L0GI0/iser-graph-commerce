...
export type IserSidebarGalleryProps = {
...
export function IserSidebarGallery(props: IserSidebarGalleryProps) {
  const {
    sidebar,
    images,
          ...
          >
            ...
            >
              {images.map((image, idx) => (
                <MotionImageAspect
                  key={typeof image.url === 'string' ? image.url : idx}
                  layout
                  layoutDependency={zoomed}
                  src={image.url}
                  width={image.width}
...
IserSidebarGallery.selectors = selectors
